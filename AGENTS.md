# AGENTS.md — Thesis Implementation: Deep Learning for CLV Prediction
...
- **Split:**
  - Stages 1–3 (`lstm_base_dunnhumby`, `lstm_joint_dunnhumby`, `transformer_joint_dunnhumby`): 80 weeks calibration + 22 weeks holdout. The available Complete Journey transaction file ends at week 101, so 80/24 is not observable without a different raw extract. Document this as the final public-data protocol.
